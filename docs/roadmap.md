...
- Define upload constraints and storage layout
- Upload, validate, hash, persist, and display images
...
- Build side-by-side image and extraction review
...
- Fetch candidate messages and attachments
